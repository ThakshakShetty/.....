...
var countDownDate = new Date("Aug 22, 2024 19:00:00").getTime();
...
sr.reveal(`.bharath`, { origin: 'left', delay: 700 });
sr.reveal(`.neha`, { origin: 'right', delay: 700 });
...
console.log('\n\n%c SAVE THE DATE: Aug 22, 2024!', styles);
